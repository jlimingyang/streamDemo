...
public class test {
    ...
    private final static String RES = " {\n" +
            "    \"isEnable\": 1,\n" +
            "    \"depotCode\": \"SC00281000027\",\n" +
            "    \"details\": [\n" +
            "      {\n" +
            "        \"settingType\": 4,\n" +
            "        \"beginTime\": \"2019-07-08 15:21\",\n" +
            "        \"endTime\": \"2019-07-08 20:21\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"settingType\": 4,\n" +
            "        \"beginTime\": \"2019-07-09 09:30\",\n" +
            "        \"endTime\": \"2019-07-09 10:30\"\n" +
            "      },\n" + "    " +
            "  {\n" +
            "        \"settingType\": 4,\n" +
            "        \"beginTime\": \"2019-07-09 14:30\",\n" +
            "        \"endTime\": \"2019-07-09 16:30\"\n" +
            "      },\n" + "  {\n" +
            "        \"settingType\": 4,\n" +
            "        \"beginTime\": \"2019-07-09 17:30\",\n" +
            "        \"endTime\": \"2019-07-09 21:30\"\n" +
            "      },\n" + "  {\n" +
            "        \"settingType\": 4,\n" +
            "        \"beginTime\": \"2019-07-10 14:30\",\n" +
            "        \"endTime\": \"2019-07-10 16:30\"\n" +
            "      },\n" +
            "      {\n" +
            "        \"settingType\": 1,\n" +
            "        \"beginTime\": \"08:21\",\n" +
        ...
        for (int i = 0; i < 3; i++) {
            ...
            switch (i) {
                ...
                case 1:
                    ...
                    respVo.setDetails(this.handleTime(dateTime, receiveTimeSettingDetailVosMap, specialTimes1));
                    receiveTimeMap.put("tomorrow", respVo);
                    break;
                case 2:
                    List<ReceiveTimeSettingDetailVo> specialTimes2 = this.getSpecialTimes(dateTime, receiveTimeSettingVo);
                    respVo.setDetails(this.handleTime(dateTime, receiveTimeSettingDetailVosMap, specialTimes2));
                    receiveTimeMap.put("lastday", respVo);
                    break;
                default:
                    break;
            }
...
//        if (!handleDate.isEqual(LocalDate.of(2019, 7, 9))) {
//            return recevieTimeList;
//        }
        //处理时间段
        for (Integer key : receiveTimeSettingDetailVosMap.keySet()) {
            ReceiveTimeSettingDetailVo receiveTimeSettingDetailVo = receiveTimeSettingDetailVosMap.get(key);
            if (Objects.nonNull(receiveTimeSettingDetailVo)) {
//                log.debug("处理时间段:{}-{}", receiveTimeSettingDetailVo.getBeginTime(), receiveTimeSettingDetailVo.getEndTime());
        ...
        for (ReceiveTimeSettingDetailVo r : recevieTimes.stream().distinct()
                .sorted(Comparator.comparing(ReceiveTimeSettingDetailVo::getBeginTime))
                .collect(Collectors.toList())) {
            if (Objects.isNull(temp)) {
                recevieTimeList.add(r);
                if (this.getByTimeStr(r.getEndTime()).isAfter(LocalTime.of(9, 0))
